...
namespace FinApp.Infrastructure.Expenses.Services
{
    internal class ExpensesDbContext : DbContext
    {
        ...
        public DbSet<ConsumptionTypeDbDto> ConsumptionTypes { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ConsumptionTypeDbDto>().HasData(new ConsumptionTypeDbDto
            {
                Id = electicityGuid,
                Name = "Prąd",
                Unit = UnitType.kWh
            }, new ConsumptionTypeDbDto
            {
                Id = gasGuid,
                Name = "Gaz",
            ...
            modelBuilder.Entity<ExpenseDbDto>().HasData(new ExpenseDbDto
            {
